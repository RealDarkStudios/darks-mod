...
public class DarkEssenceItem extends DarksmodModElements.ModElement {
	@ObjectHolder("darksmod:dark_essence")
	public static final Item block = null;
	public DarkEssenceItem(DarksmodModElements instance) {
		super(instance, 8);
	}
